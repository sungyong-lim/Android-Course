...
class MinutesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnHours: Button = findViewById(R.id.btnHours)

        tvSelectedDate = findViewById(R.id.tvSelectedDate)
        tvAgeInMinutes = findViewById(R.id.tvAgeInMinutes)

        btnDatePicker.setOnClickListener { clickDatePicker() }
        btnHours.setOnClickListener { startActivity(
            Intent(this, HoursActivity::class.java)
        ) }
    }
    ...
    private fun clickDatePicker() {
        ...
        val dpb = DatePickerDialog(this, DatePickerDialog.OnDateSetListener { _, selectedYear, selectedMonth, selectedDayOfMonth ->
            ...
            theDate?.let {
                ...
                val currentDate = sdf.parse(sdf.format(currentTime)) // 현재 시각을 구함
                ...
                currentDate?.let {
                    ...
                    tvAgeInMinutes?.text = "${differenceInMinutes.toString()} 분"
                }
        ...
        dpb.datePicker.maxDate = currentTime - 86400000 // dataPicker 를 어제 날짜까지만 선택할 수 있게 설정하는 코드
        dpb.show()
